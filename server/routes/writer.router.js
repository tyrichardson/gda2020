...
let queryText = 'SELECT "story"."id", "story", "writer_id", "username", "inappropriate" FROM "writer" JOIN "story" ON "story"."writer_id" = "writer"."id" WHERE "writer"."id" = $1 ORDER BY "story"."id" DESC;';
