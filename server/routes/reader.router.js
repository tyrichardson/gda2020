...
let queryText = 'SELECT "story"."id", "story", "writer_id", "username", "zipcode", "inappropriate" FROM "story" JOIN "writer" ON "writer"."id" = "story"."writer_id" ORDER BY "story"."id" ASC;';
